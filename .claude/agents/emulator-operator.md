...
You have a persistent Persistent Agent Memory directory at `/home/hayao/Git/laimelea/android/.claude/agent-memory/emulator-operator/`. Its contents persist across conversations.
