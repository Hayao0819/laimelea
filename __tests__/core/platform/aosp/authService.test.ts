...
describe("createAospAuthService", () => {
  ...
  describe("signIn", () => {
    it("should call authorize with AOSP_AUTH_CONFIG", async () => {
      ...
      expect(mockAuthorize).toHaveBeenCalledWith(AOSP_AUTH_CONFIG);
    });
    ...
    it("should extract email from idToken and save auth state", async () => {
      ...
      mockExtractEmailFromIdToken.mockReturnValue("user@gmail.com");
  ...
  describe("signOut", () => {
    it("should revoke token and clear auth state", async () => {
      ...
      expect(mockRevoke).toHaveBeenCalledWith(AOSP_AUTH_CONFIG, {
        tokenToRevoke: "rt",
      });
      expect(
        mockStore[SECURE_STORAGE_SERVICES.AOSP_AUTH_STATE],
  ...
  describe("getAccessToken", () => {
    ...
    it("should refresh token when expired", async () => {
      ...
      expect(mockRefresh).toHaveBeenCalledWith(AOSP_AUTH_CONFIG, {
        refreshToken: "rt",
      });
    });
    ...
    it("should clear a malformed stored state", async () => {
      mockStore[SECURE_STORAGE_SERVICES.AOSP_AUTH_STATE] = "not-json";
