...
describe("LegalScreen", () => {
  ...
  it("should display app license section heading", async () => {
    const { getByText } = await renderWithProviders();
    expect(getByText("settings.appLicense")).toBeTruthy();
  });
  ...
  it("should not crash when Linking.openURL fails", async () => {
